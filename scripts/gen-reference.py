...
Canonical generator for src/methods/__fixtures__/reference.json — independent
...
Run:      npm run reference:generate
          ...
          the JS step dumps shared test fixtures from src/methods/fixtures/core.js to
...
# Fixture data shared with the JS test suite (src/methods/fixtures/core.js), dumped via
...
# Fixture groups (GROUP_A/B/C from src/methods/fixtures/core.js — equal n=7, equal
...
if __name__ == '__main__':
    import os
    os.makedirs('src/methods/__fixtures__', exist_ok=True)
    with open('src/methods/__fixtures__/reference.json', 'w') as f:
        json.dump(ref, f, indent=2, default=_default)
        f.write('\n')
    print('Written to src/methods/__fixtures__/reference.json')
